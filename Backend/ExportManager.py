...
def GenerateListForImportLoad(filename, Data):
    ...
    for curRow in range(2, len(rows) - 1, 2):
        ...
        newList = [datapoints[1], datapoints[0], datapoints[2], datapoints[3], datapoints[8], Time1Min, Time1Sec, Time2Min, Time2Sec, Time3Min, Time3Sec, datapoints[15],
                   datapoints[14], datapoints[9], datapoints[10], datapoints[11], datapoints[4], datapoints[12], RemoveEndQuotes(datapoints[13]), Data]
        formattedRows.append(newList)

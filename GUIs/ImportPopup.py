...
def getFile(fileNameBox):
    filename = filedialog.askopenfilename(initialdir="/", title="Select file", filetypes=(("csv files", "*.csv"), ("excel files", "*.xlsx"), ("all files", "*.*")))
...
def ImportPopup(Data):
    ...
    DropMenu = OptionMenu(root, Drop, "  Team Information  ", "  Written Report Scores  ", "  Table Backup  ", "  2-leg Teams  ", "  4-leg Teams  ")

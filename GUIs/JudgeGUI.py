...
def JudgeGUI(defaultFont):
    ...
    TotalFrame.grid(row=7, column=1, sticky='W', padx=5, pady=5, ipadx=5, ipady=5)
    ...
    CommentsFrame.grid(row=8, column=0, columnspan=2, sticky='W', padx=5, pady=5, ipadx=5, ipady=5)
    ...
    UpdateButton = Button(fieldsFrame, text=" Update ", command=lambda: dbCommands.Update(NameBox.get(),\
                                                                                      ...
                                                                                      Data), font=(Data.font, Data.fontSize))

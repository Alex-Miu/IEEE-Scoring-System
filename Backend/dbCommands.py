...
def Connect(dbName, dbIP, dbUser, dbPass, Data, dbTable, titleLabel, day):
    ...
    SettingsPopup.SaveData(Data.dbName, Data.dbIP, Data.dbUser, Data.dbPass, Data, Data.fontSize, Data.dbTable.strip('`'), Data.delay, Data.height, Data.today)
...
def FetchTeams(data, competition_type):
    ...
    # TODO add method here that, if connected == False, then pull data from the file in Resources/Backup.
    # TODO File name will be "competition_type_offset.xlsx"
